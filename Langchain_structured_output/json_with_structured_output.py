...
# ****************this model didin't support  :json schema is not supported for (with_structured_output)function calling *******************************
# we need creat out parser for this in the coming practice.
